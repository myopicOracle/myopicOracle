...
- **[Bootcamps & Certificates](#bootcamps--certificates)**  
  - [AWS Certified Cloud Practitioner](#aws-certified-cloud-practitioner-clf-c02)  •  [The Odin Project](#the-odin-project---full-stack-javascript-track)  •  [App Brewery Bootcamp](#the-complete-full-stack-web-development-bootcamp)  •  [IBM Data Analyst Professional](#ibm-data-analyst-professional-certification)  •  [Microsoft Azure AI-900](#microsoft-azure-ai-900)  
...
- **[3D Metaverse with Fully Decentralized Authentication](#3d-metaverse-with-fully-decentralized-authentication)**  
...
- **[End-to-End AI Infrastructure: Deploy Local LLMs Remotely](#end-to-end-ai-infrastructure-deploy-local-llms-remotely)**  
...
### **Completed:**   
##### **[AWS Certified Cloud Practitioner [CLF-C02]](https://cp.certmetrics.com/amazon/en/public/verify/credential/56fe8b6f85d54ddf8a57b2697566121c){:target="_blank" rel="noopener noreferrer"} (Aug 2025)** 
...
##### **[The Odin Project - Full Stack Javascript Track](https://www.theodinproject.com/){:target="_blank" rel="noopener noreferrer"} (Nov 2024 - Jun 2025)** 
...
##### **[The Complete Full Stack Web Development Bootcamp](http://ude.my/UC-118e5203-a255-4989-81d8-38cb83fa120){:target="_blank" rel="noopener noreferrer"} (May 2024 - Jun 2025)**   
...
Independent final project in Scrimba's ["Intro to AI Engineering"](https://scrimba.com/the-ai-engineer-path-c02v){:target="_blank" rel="noopener noreferrer"} course - specifically OpenAI API integration, zero-shot vs few-shot prompting, and parameter tuning (temperature, stop-sequences, frequency/presence penalties). 
...
#### **[Live Demo - Click "Don't Have MetaMask Wallet?" To Bypass SIWE Auth](https://the-metaverse-by-myopicoracle-demo-v3-565993571311.us-west1.run.app){:target="_blank" rel="noopener noreferrer"}**
...
**3D environment adapted from Claude Artifact ["Anthropic Office Simulator"](https://claude.ai/public/artifacts/c33e575f-5228-4058-aa78-a998bad7ec71){:target="_blank" rel="noopener noreferrer"}**, which uses HTML/JS and mocked AI responses. Adapted to use React.js and integrated Gemini API for real chatbot and NPC interactions.
...
[Project Repo](https://github.com/myopicOracle/run-local-llm-with-gui){:target="_blank" rel="noopener noreferrer"} • [Video Walkthroughs on YouTube](https://youtu.be/YrV2Q_hCtw8?si=4jOrmUvKViu6QonI&t=12){:target="_blank" rel="noopener noreferrer"}
...
[Project Repo](https://github.com/myopicOracle/prototypes-library){:target="_blank" rel="noopener noreferrer"}
...
[🔗 Live Demo](https://simple-resume-app.netlify.app/){:target="_blank" rel="noopener noreferrer"} • [Project Repo](https://github.com/myopicOracle/resume-builder){:target="_blank" rel="noopener noreferrer"}
